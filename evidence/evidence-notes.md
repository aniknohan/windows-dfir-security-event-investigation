...
**Screenshot:** `01-windows-dfir-lab-directory-structure.png`
...
**Screenshot:** `02-evidence-artifact-inventory.png`
...
**Screenshot:** `03-prefetch-artifact-inventory.png`
...
**Screenshot:** `04-lnk-artifact-inventory.png`
...
**Screenshot:** `05-chrome-artifact-inventory.png`
...
**Screenshot:** `06-chrome-artifact-metadata.png`
...
**Screenshot:** `07-authentication-timeline.png`
...
**Screenshot:** `08-prefetch-execution-timeline.png`
...
**Screenshot:** `09-lnk-artifact-timeline.png`
...
**Screenshot:** `10-lnk-target-paths.png`
...
**Screenshot:** `11-jumplist-file-references.png`
...
**Screenshot:** `12-chrome-download-url-correlation.png`
...
**Screenshot:** `13-chrome-download-timestamps-utc.png`
...
**Screenshot:** `14-chrome-history-zimmermantoools-timeline.png`
...
**Screenshot:** `15-chrome-history-zimmermantools-script-visit.png`
...
**Screenshot:** `16-chrome-github-zimmermantools-filtered-history.png`
...
**Screenshot:** `17-security-event-4624-microsoft-account-cached-interactive-logon.png`
...
**Screenshot:** `18-security-event-4720-dfir-test-account-created.png`
...
**Screenshot:** `19-security-event-4722-dfir-test-account-enabled.png`
...
**Screenshot:** `20-security-event-4724-dfir-test-password-reset-attempt.png`
...
**Screenshot:** `21-dfir-test-event-4647-logoff-summary.png`
...
**Screenshot:** `22-special-privileges-event-4672-system.png`
...
**Screenshot:** `23-dfir-test-event-4647-user-logoff.png`
...
**Screenshot:** `24-special-privileges-microsoft-account-4672.png`
...
**Screenshot:** `25-dfir-test-event-4720-account-creation-logon-id-correlation.png`
...
**Screenshot:** `26-dfir-test-correlated-session-timeline.png`
...
**Screenshot:** `27-dfir-test-added-to-users-group-4732.png`
...
**Screenshot:** `28-dfir-test-session-duration.png`
...
**Screenshot:** `29-dfir-test-event-4648-explicit-credentials.png`
...
**Screenshot:** `30-no-dfir-test-administrators-membership-4732.png`
...
**Screenshot:** `31-dfir-test-4648-4624-authentication-correlation.png`
...
**Screenshot:** `32-no-dfir-test-special-privileges-4672.png`
...
**Screenshot:** `33-dfir-test-event-4797-blank-password-query.png`
...
**Screenshot:** `34-no-process-creation-events-dfir-test-4688.png`
...
**Screenshot:** `35-dfir-test-event-4799-administrators-enumeration.png`
...
**Screenshot:** `36-no-failed-logons-dfir-test-4625.png`
...
**Screenshot:** `37-dfir-test-event-4798-user-group-enumeration.png`
...
**Screenshot:** `38-dfir-test-event-4797-blank-password-query.png`
...
**Screenshot:** `39-dfir-test-event-4797-account-enumeration.png`
...
**Screenshot:** `40-dfir-test-account-discovery-timeline.png`
...
**Screenshot:** `41-dfir-test-global-group-membership-4728.png`
...
**Screenshot:** `42-dfir-test-added-to-users-4732.png`
...
**Screenshot:** `43-dfir-test-added-to-users-group-4732.png`
...
**Screenshot:** `44-dfir-test-account-changed-4738.png`
...
**Screenshot:** `45-chrome-download-chatgpt-referrer.png`
...
**Screenshot:** `46-chrome-download-completion-state.png`
...
**Screenshot:** `47-chrome-download-ntfs-timestamp-correlation.png`
...
**Screenshot:** `48-chrome-download-tab-url-zimmermantools.png`
...
**Screenshot:** `49-chrome-download-target-path-get-zimmermantools.png`
...
**Screenshot:** `50-chrome-github-zimmermantools-script-visit.png`
...
**Screenshot:** `51-chrome-history-get-zimmermantools-github-163745.png`
...
**Screenshot:** `52-chrome-history-get-zimmermantools-ps1-163757.png`
...
**Screenshot:** `53-chrome-history-network-last-visit-time.png`
...
**Screenshot:** `54-chrome-history-network-security-report.png`
...
**Screenshot:** `55-chrome-timeline-chatgpt-to-github.png`
...
**Screenshot:** `56-chrome-zimmermantools-download-metadata.png`
...
**Screenshot:** `57-chrome-zimmermantools-download-time-163808.png`
...
**Screenshot:** `58-credential-manager-5379-enumeration.png`
...
**Screenshot:** `59-dfir-test-5058-key-file-operation.png`
...
**Screenshot:** `60-dfir-test-5059-key-migration-operation.png`
...
**Screenshot:** `61-dfir-test-5061-cryptographic-operation.png`
...
**Screenshot:** `62-dfir-test-account-creation-timeline.png`
...
**Screenshot:** `63-dfir-test-credential-manager-enumeration.png`
...
**Screenshot:** `64-dfir-test-logon-session-timeline.png`
...
**Screenshot:** `65-dfir-test-successful-logon-4624.png`
...
**Screenshot:** `66-event-4624-dfir-test-successful-logon.png`
...
**Screenshot:** `67-evidence-hash-manifest-prefetch-security.png`
...
**Screenshot:** `68-evidence-hash-manifest-sha256.png`
...
**Screenshot:** `69-filesystem-zimmerman-timestamp-correlation.png`
...
**Screenshot:** `70-investigation-report-created.png`
...
**Screenshot:** `71-investigation-report-sha256.png`
...
**Screenshot:** `72-investigation-timeline-sha256.png`
...
**Screenshot:** `73-security-evtx-file-metadata.png`
...
**Screenshot:** `74-linked-logon-0x630B8-event-correlation.png`
...
**Screenshot:** `75-logon-id-0x630F9-event-correlation.png`
...
**Screenshot:** `76-powershell-get-zimmermantools-sha256.png`
...
**Screenshot:** `77-powershell-get-zimmermantools-zone-identifier.png`
...
**Screenshot:** `78-powershell-psreadline-zimmerman-command-history.png`
...
**Screenshot:** `79-powershell-psreadline-zimmerman-execution-history.png`
...
**Screenshot:** `80-powershell-zimmermantools-empty-directory.png`
...
**Screenshot:** `81-powershell-zimmermantools-event-4100-count.png`
...
**Screenshot:** `82-powershell-zimmermantools-event-4100.png`
...
**Screenshot:** `83-powershell-zimmermantools-filesystem-timestamps.png`
...
**Screenshot:** `84-powershell-zimmermantools-first-4100-error-details.png`
...
**Screenshot:** `85-powershell-zimmermantools-first-event-4100.png`
...
**Screenshot:** `86-powershell-zimmermantools-script-attribution-4100.png`
...
**Screenshot:** `87-reports-directory-created.png`
...
**Screenshot:** `88-security-evtx-event-log-summary.png`
...
**Screenshot:** `89-security-event-4624-logon-type-summary.png`
...
**Screenshot:** `90-security-event-4624-logon-type-details.png`
...
**Screenshot:** `91-security-event-4624-dfir-test-logons.png`
...
**Screenshot:** `92-security-event-4672-dfir-test-special-privileges.png`
...
**Screenshot:** `93-security-event-4648-dfir-test-explicit-credentials.png`
...
**Screenshot:** `94-security-event-5379-dfir-test-credential-manager.png`
...
**Screenshot:** `95-security-event-5058-dfir-test-key-file-operation.png`
...
**Screenshot:** `96-security-event-5059-dfir-test-key-migration-operation.png`
...
**Screenshot:** `97-security-event-5061-dfir-test-cryptographic-operation.png`
...
**Screenshot:** `98-security-event-4799-dfir-test-group-membership.png`
...
**Screenshot:** `99-security-event-4798-dfir-test-user-group-enumeration.png`
...
**Screenshot:** `100-security-event-4797-dfir-test-blank-password-query.png`
...
**Screenshot:** `101-security-event-4647-dfir-test-user-logoff.png`
...
**Screenshot:** `102-security-event-dfir-test-session-timeline.png`
...
**Screenshot:** `103-security-event-dfir-test-account-activity-summary.png`
...
**Screenshot:** `104-security-event-dfir-test-account-lifecycle-timeline.png`
...
**Screenshot:** `105-security-event-dfir-test-account-discovery-summary.png`
...
**Screenshot:** `106-security-event-dfir-test-authentication-summary.png`
...
**Screenshot:** `107-dfir-test-failed-logon-event-4625.png`
...
**Screenshot:** `108-dfir-test-failed-logon-bad-password-event-4625.png`
...
**Screenshot:** `109-dfir-test-correlated-security-event-timeline.png`
...
**Screenshot:** `110-dfir-test-account-created-event-4720.png`
...
**Screenshot:** `111-dfir-test-account-enabled-event-4722.png`
...
**Screenshot:** `112-dfir-test-password-reset-event-4724.png`
...
**Screenshot:** `113-dfir-test-global-group-membership-event-4728.png`
...
**Screenshot:** `114-dfir-test-users-group-membership-event-4732.png`
...
**Screenshot:** `115-dfir-test-account-changed-event-4738.png`
...
**Screenshot:** `116-linked-logon-session-event-correlation.png`
...
**Screenshot:** `117-linked-logon-successful-logon-event-4624.png`
...
**Screenshot:** `118-security-event-4624-no-interactive-logons.png`
...
**Screenshot:** `119-security-event-4624-successful-service-logon.png`
...
**Screenshot:** `120-security-event-4672-system-special-privileges.png`
...
**Screenshot:** `121-security-event-4798-local-group-enumeration.png`
...
**Screenshot:** `122-security-event-4799-group-membership-enumeration.png`
...
**Screenshot:** `123-security-event-correlation-timeline.png`
...
**Screenshot:** `124-security-event-timeline-1233.png`
...
**Screenshot:** `125-security-event-timeline-dfir-test.png`
...
**Screenshot:** `126-security-evtx-4688-powershell-no-results.png`
...
**Screenshot:** `127-security-evtx-4688-process-summary.png`
...
**Screenshot:** `128-security-evtx-event-4688-process-creation.png`
...
**Screenshot:** `129-security-evtx-event-id-frequency.png`
...
**Screenshot:** `130-security-evtx-evidence-metadata.png`
...
**Screenshot:** `131-security-evtx-integrity-verification.png`
...
**Screenshot:** `132-security-evtx-sha256-hash.png`
...
**Screenshot:** `133-security-evtx-sha256-integrity.png`
...
**Screenshot:** `134-windows-dfir-lab-directory-tree-part-1.png`
...
**Screenshot:** `135-windows-dfir-lab-directory-tree-part-2.png`
...
**Screenshot:** `136-zimmerman-tools-correlated-execution-timeline.png`
...
**Screenshot:** `137-zimmerman-tools-empty-directory-evidence.png`
